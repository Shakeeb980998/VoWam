...
export default function RoleModal({ isOpen, onClose, onSave, initialData = null, isLoading = false }) {
              ...
              <form onSubmit={handleSubmit} className="modal-form">
                ...
                <div className="form-group">
                  ...
                  <textarea 
                    ...
                    placeholder="Detailed description of the role responsibilities..."
                    rows={4}
                    disabled={isLoading}
                  />
                </div>
                ...
                <div className="modal-footer">
                  ...
                  <button type="submit" className="btn-primary" disabled={!roleCode || isLoading}>
                    <Save size={18} />
